...
const stripePromise = loadStripe("pk_test_51LfpUKGsGfiflfqm1QENQI24b7bNZrXGTPeivGqWl3bg6abaSB3SiGojefn4NUWHAiJw6yfPunzNaqBqHUjg9ixs00ZA1D73du")
    ...
    <Container style={{minHeight: "95vh"}} className="cart-container">
        <Row>
            <Col>
                ...
                {cart.length === 0 ? (
                    <Alert variant="info">Shopping cart empty. Add products to your cart</Alert>
                ) : (
                                ...
                                <tbody>
                                    ...
                                    {cart.map(item => (
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>
                                                {!isLoading && <i className="fa fa-times-circle" style={{marginRight: 10, cursor: "pointer"}} onClick={() => removeFromCart({ productId: item._id, price: item.price, userId: user._id})}></i>}
